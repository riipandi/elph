...
func TestBuildIncludesDynamicTools(t *testing.T) {
	...
	require.Contains(t, got, "`ExitPlanMode` requires user confirmation after completion.")
	require.Contains(t, got, "### Collaboration Tools")
	require.Contains(t, got, "Collaboration tools handle inter-Agent coordination")
