...
| Value   | Behavior                                                                                                                                                                                                                 |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `lazy`  | Skip `tools/list` (and resources/prompts discovery) at load time. Tools are discovered on first `create_agent_tools`, `call_tool`, `read_resource`, or `get_prompt`. Reduces startup cost and isolates slow MCP servers. |
