...
use crate::linkify::spans_with_links;
use crate::model::{MarkdownDocument, MarkdownLine, MarkdownLineKind, MarkdownTable, StyledSpan};
use crate::parser_config::offset_events;
use crate::theme::MarkdownTheme;

#[derive(Clone, Copy, Default)]
struct SpanStyle {
    color: Option<crate::model::RgbColor>,
    weight: crate::model::FontWeight,
    italic: bool,
}

impl SpanStyle {
    fn apply(self, theme: &MarkdownTheme) -> (crate::model::RgbColor, crate::model::FontWeight, bool) {
...
impl<'a> ParserState<'a> {
    ...
    fn push_style(&mut self, layer: SpanStyle) {
        ...
        self.style_stack.push(SpanStyle {
            ...
            weight: if layer.weight != crate::model::FontWeight::Normal {
                layer.weight
            } else {
                base.weight
            },
        ...
        match event {
            ...
            Event::Start(Tag::BlockQuote(_)) => {
                ...
                state.push_style(SpanStyle {
                    ...
                    weight: crate::model::FontWeight::Normal,
                    italic: true,
                });
            }
            ...
            Event::Start(Tag::Strong) => {
                state.push_style(SpanStyle {
                    ...
                    weight: crate::model::FontWeight::Bold,
                    italic: false,
                });
            }
