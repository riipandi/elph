//! Shared `pulldown-cmark` configuration for the rendown markdown pipeline.

use pulldown_cmark::{Event, Options, Parser, Tag, TagEnd};
use std::ops::Range;

/// Parser options for assistant markdown (GFM + extensions).
...
/// Returns true when an open list or blockquote remains at `end`.
