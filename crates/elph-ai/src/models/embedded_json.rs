//! Embedded raw provider catalog JSON for CONFIG_DIR unpack (auto-generated by `generate-models chat` — do not edit).
...
pub fn embedded_provider_json() -> &'static [(&'static str, &'static str)] {
    &[
        ...
        (
            "infron",
            include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/models/infron.json")),
        ),
