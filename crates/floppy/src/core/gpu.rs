...
fn detect_gpu_backend() -> GpuBackend {
    ...
    *DETECTED.get_or_init(|| {
        // GPU features are currently disabled due to embed_anything 0.7.1 dependency issues
        // with candle-core. When upstream is fixed, uncomment the detection logic below.
...
fn has_nvidia_gpu() -> bool {
    ...
    // For now, we assume if embed_anything/cuda feature is compiled, CUDA is available
