...
use crate::harness::types::{SystemPrompt, clone_stream_options};
use crate::mode::{CollaborationMode, plan_mode_system_prompt};
...
{
    pub(in crate::harness::agent_harness) async fn create_turn_state(&self) -> HarnessOpResult<AgentHarnessTurnState> {
