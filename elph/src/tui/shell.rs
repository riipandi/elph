...
#[derive(Clone)]
struct ShellCtx {
    active_plan_file: Ref<Option<String>>,
    activity_label: State<String>,
    activity_started_at: Ref<Option<Instant>>,
    agent_mode: State<AgentMode>,
    agent_session: Option<Arc<CodingAgentSession>>,
    agent_session_slot: Ref<Option<Arc<CodingAgentSession>>>,
    agent_turn_active: State<bool>,
    allow_mode_change_while_busy: State<bool>,
    approval_selected: State<usize>,
    auto_expand_thinking: bool,
    bootstrap_config: Ref<Option<TuiBootstrapConfig>>,
    bootstrap_phase: Ref<BootstrapPhase>,
    bootstrap_rx: Ref<Option<UnboundedReceiver<BootstrapUiEvent>>>,
    bootstrap_worker_started: Ref<bool>,
    busy: State<bool>,
    busy_started_at: Ref<Option<Instant>>,
    chrome_eager_paint_done: Ref<bool>,
    chrome_full_redraw_pending: Ref<bool>,
    chrome_refresh_pending: State<bool>,
    chrome_stats: State<ChromeStats>,
    chrome_tick: Ref<u32>,
    chrome_ui_revision: State<u64>,
    clipboard_toast: State<Option<elph_tui::ClipboardNotice>>,
    colored_status_footer: bool,
    confetti_frame: State<u32>,
    confetti_runtime: Ref<Option<ConfettiRuntime>>,
    cwd: PathBuf,
    cwd_for_loop: PathBuf,
    cwd_for_mention_index: PathBuf,
    draft: State<String>,
    ephemeral_banner: State<Option<EphemeralBanner>>,
    ephemeral_banner_generation: Ref<EphemeralBannerGeneration>,
    ephemeral_expire: Ref<EphemeralExpireChannel>,
    event_applier: Ref<TranscriptEventApplier>,
    execution_env: Arc<LocalExecutionEnv>,
    extension_host: ExtensionHost,
    extension_host_for_loop: ExtensionHost,
    extension_host_for_palette: ExtensionHost,
    fallback_context_limit: u64,
    fallback_model_label: String,
    fallback_model_label_for_chrome: String,
    fallback_supports_images: bool,
    file_picker_active: Ref<bool>,
    file_picker_index: State<usize>,
    file_picker_key_handled: Ref<bool>,
    file_picker_query: Ref<String>,
    file_picker_show_hidden: State<bool>,
    file_picker_suppressed: Ref<bool>,
    footer_token_display: String,
    force_editor_clear: Ref<bool>,
    force_palette_sync: Ref<bool>,
    git_footer: State<Option<GitFooterInfo>>,
    idle_status_notice: Ref<Option<IdleStatusNotice>>,
    input_prefix_kind: Ref<InputPrefixKind>,
    last_activity_label: Ref<String>,
    last_arrow_up_at: Ref<Instant>,
    last_event_burst: Ref<usize>,
    last_transcript_publish: Ref<Instant>,
    layout_screen_size_for_loop: State<(u16, u16)>,
    live_cursor: Ref<usize>,
    live_draft: Ref<String>,
    live_session_id: State<String>,
    mention_index: Ref<Option<Arc<MentionSearchIndex>>>,
    mention_index_requested: Ref<bool>,
    messages: State<Vec<TranscriptMessage>>,
    messages_arc: Ref<Arc<RwLock<Vec<TranscriptMessage>>>>,
    messages_arc_inner: Arc<RwLock<Vec<TranscriptMessage>>>,
    messages_for_tick: State<Vec<TranscriptMessage>>,
    messages_revision: State<u64>,
    messages_revision_for_tick: State<u64>,
    model_filter: State<String>,
    model_input_focus: State<ModelSelectorFocus>,
    model_provider_index: State<usize>,
    model_selected_index: State<usize>,
    new_session_requested: Ref<bool>,
    on_queue_action_click: Handler<(usize, PromptQueueAction)>,
    palette_refresh_pending: State<bool>,
    paths: State<Paths>,
    pending_confetti: Ref<Option<PendingConfetti>>,
    pending_feedback: Ref<bool>,
    pending_mode_change: Ref<Option<PendingModeChange>>,
    pending_model_selector: Ref<Option<PendingModelSelector>>,
    pending_plan_confirmation: Ref<Option<PendingPlanConfirmation>>,
    pending_provider_api_key: Ref<Option<PendingProviderApiKeyDialog>>,
    pending_provider_connect: Ref<Option<PendingProviderConnectDialog>>,
    pending_provider_connect_for_tick: Ref<Option<PendingProviderConnectDialog>>,
    pending_provider_disconnect: Ref<Option<PendingProviderDisconnectDialog>>,
    pending_provider_disconnect_for_tick: Ref<Option<PendingProviderDisconnectDialog>>,
    pending_queue_click: State<Option<(usize, PromptQueueAction)>>,
    pending_quit_confirm: Ref<bool>,
    pending_rename: Ref<Option<PendingRenameDialog>>,
    pending_scoped_models: Ref<Option<PendingScopedModels>>,
    pending_subagent_output: Ref<Option<PendingSubagentOutputDialog>>,
    pending_system_prompt: Ref<Option<PendingSystemPromptDialog>>,
    pending_tool_approval: Ref<Option<PendingToolApproval>>,
    pending_transcript_notice_expires: Ref<HashMap<&'static str, Instant>>,
    pending_user_question: Ref<Option<PendingUserQuestion>>,
    pre_echoed_user_prompts: State<u32>,
    prompt_editor_mirror: Ref<(String, usize)>,
    prompt_history: Ref<Vec<String>>,
    prompt_history_index: State<usize>,
    prompt_history_open: State<bool>,
    prompt_queue: Ref<PromptQueue>,
    prompt_templates: State<Vec<PromptTemplate>>,
    provider_connect_api_key: State<String>,
    provider_connect_api_key_for_tick: State<String>,
    provider_connect_filter: State<String>,
    provider_connect_input_focus: State<ProviderConnectFocus>,
    provider_connect_input_focus_for_tick: State<ProviderConnectFocus>,
    provider_connect_selected: State<usize>,
    provider_disconnect_selected: State<usize>,
    question_answer: State<String>,
    question_confirm_focus: State<ConfirmButtonFocus>,
    question_input_focus: State<QuestionInputFocus>,
    question_multi_checked: State<Vec<bool>>,
    question_selected: State<usize>,
    question_validation_error: State<Option<String>>,
    queue_manager_action: State<PromptQueueAction>,
    queue_manager_open: State<bool>,
    queue_manager_selected: State<usize>,
    queue_ui_revision: State<u64>,
    rename_value: State<String>,
    scoped_filter: State<String>,
    scoped_selected_index: State<usize>,
    screen_height: u16,
    screen_width: u16,
    select_mode: State<bool>,
    session_elapsed_secs: State<f64>,
    session_id: String,
    session_scoped_items: Ref<Vec<String>>,
    session_wall_started_at: Ref<Instant>,
    shell_focus: State<ShellFocus>,
    shell_focus_for_tick: State<ShellFocus>,
    shift_held: State<bool>,
    shift_last_pressed: Ref<Option<Instant>>,
    should_exit: State<bool>,
    show_thinking: bool,
    skills: State<Vec<Skill>>,
    skills_count: State<usize>,
    slash_commands: State<Vec<SlashCommand>>,
    slash_palette_active: Ref<bool>,
    slash_palette_index: State<usize>,
    slash_palette_query: Ref<String>,
    styled_content: Ref<String>,
    subagent_output_buffers: Arc<RwLock<HashMap<String, SubagentBuf>>>,
    subagent_output_buffers_state: Ref<Arc<RwLock<HashMap<String, SubagentBuf>>>>,
    subagent_output_scroll: Ref<ScrollViewHandle>,
    subagent_output_scroll_tick: State<u32>,
    suppress_enter_newline: Ref<bool>,
    system_prompt_scroll: Ref<ScrollViewHandle>,
    system_prompt_scroll_tick: Ref<u32>,
    thinking_level: State<ThinkingLevel>,
    transcript_pending: Ref<bool>,
    turn_cancel_requested: Ref<bool>,
    turn_token_tracker: Ref<Option<TurnTokenTracker>>,
    ui_events_slot: Ref<Option<Arc<Mutex<UnboundedReceiver<AgentUiEvent>>>>>,
    user_shell_abort: Ref<Option<CancellationToken>>,
    user_shell_channel: Ref<UserShellChannel>,
}
...
async fn shell_tick_loop(ctx: ShellCtx) {
    let ShellCtx {
...
fn handle_shell_key(ctx: ShellCtx, event: TerminalEvent) {
    let ShellCtx {
        mut active_plan_file,
        mut activity_label,
        mut activity_started_at,
